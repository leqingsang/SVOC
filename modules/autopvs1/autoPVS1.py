...
class AutoPVS1:
    ...
    def vep_run(self):
        ...
        vepcommand = '''
            modules/ensembl-vep/vep --offline --refseq --use_given_ref \
            --dir_cache ''' + vep_cache + ''' \
        ...
        '''
        os.system(vepcommand) # 使用Python的os.system函数执行构建的VEP命令
